...
We consider constraint learning and pattern mining to be interconnected, and both problems play a central role in this thesis.
\sergey{EXPLAIN AND EXTEND THIS}
...
our relational learning setting. \sergey{explain and extend this}
...
A well familiar example of relational data is an examination schedule 
...
confidence that for a number of important problems \sergey{ELABORATE} it is essential to
...
%  Similarly to unstructured constraint-based itemset mining: 
    ...
    and query mining? We introduce \textbf{Structured Frequent Pattern
        Mining} as a possible solution to this problem.
\end{itemize}
\pubrevend
...
learning problem \sergey{ELABORATE}. In a spreadsheet, columns are no longer variables
