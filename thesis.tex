\documentclass[final,showinstructions,faculty=firw,department=cws,phddegree=cws]{adsphd}
...
%%% COVER: Settings %%%
\title{Modelling Relational\\ Data Mining}
...
\president{Prof.~dr. ir. Hilde Heynen}
\jury{Prof.~dr. ir. Gerda Janssens\\
